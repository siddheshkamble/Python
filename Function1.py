...
def Demo3(No):
    print("Inside Demo3 wit argument :", No)
    return No+2 

#Function accept 2 parameter and return one parameter
def Demo4(No1,No2):
    print("Inside Demo4")
    Add = No1 + No2
    return Add

#Function accept 2 parameter and return two parameter
def Demo5(No1,No2):
    print("Inside Demo5")
    Add = No1 + No2
    Sub = No1 - No2
...
def main():
    ...
    print("1st return value :",Ans1)
    print("2nd return value :",Ans2)
