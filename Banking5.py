...
def main():
    ...
    # print("Amount of User1 after deposit is :",User1.Amount)
    # print("Amount of User2 after deposit is :",User2.Amount)
    ...
    # print("Amount of User1 after Withdraw is :",User1.Amount)
    # print("Amount of User2 after Withdraw is :",User2.Amount)
